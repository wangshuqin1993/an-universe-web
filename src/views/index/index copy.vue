      ...
      <div class="">
        <div class="h-[625px] flex items-center index-bg1">
          <div class="md:w-[580px]">
            ...
            <div class="text-[22px] leading-[35px] mt-[20px] mb-[40px] text-[#EEE9E9]">Return the value of knowledge to
              the
      ...
      <div>
        ...
        <div class="mt-[120px] flex justify-between">
          <div class="flex items-center ml-[120px]">
            <div class="w-[680px]">
              <div class="text-[48px] font-bold text-[#FFFFFF] leading-[84px]">Create to earn! Sharing your Knowledge.
              </div>
              <div class="text-[22px] text-[#EEE9E9] mt-[20px] italic">

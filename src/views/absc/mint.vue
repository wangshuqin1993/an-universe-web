<template>
  ...
  <div class="w-full h-full">
    ...
    <div class="w-full h-screen" :class="isMobile == true ? 'phone-bg1-container' : 'bg1-container'">
      <div class="px-[32px] md:pt-[82px] pt-[60px]">
        <div class="absc-title "><span class="title-text text-[32px] md:text-[48px] ">$BSC Golden Shovel</span></div>
        <div class="absc-sub-title md:text-[16px] text-[14px] md:w-[860px] w-hull mx-auto">
          <div class="text-left">
      ...
      -->
        <div class="text-center md:mt-[30px] mt-[20px] px-[32px]">
